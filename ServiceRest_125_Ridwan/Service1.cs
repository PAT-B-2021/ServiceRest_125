...
namespace ServiceRest_125_Ridwan
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data source=LAPTOP-MAPV1IJL;Initial catalog=\"TI UMY\";Persist security Info=True;user ID=sa;Password=123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data source=LAPTOP-MAPV1IJL;Initial catalog=\"TI UMY\";Persist security Info=True;user ID=sa;Password=123");
